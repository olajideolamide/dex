...
- [Capturing Exceptions](/docs/helpers/capturing-exceptions/) — `dex_capture_exception()`
- [Breadcrumbs](/docs/helpers/breadcrumbs/) — `dex_breadcrumb()`
- [Spans](/docs/helpers/spans/) — `dex_span_start()`, `dex_span_finish()`, `dex_span()`
- [Helper Reference](/docs/helpers/helper-reference/) — Quick signatures and behavior notes
