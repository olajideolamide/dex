...
- [Configuration Reference](/docs/configuration/config-reference/) — Every supported config option (defaults, types, examples)
- [Securing DEX](/docs/security/overview/) — Production hardening guide
