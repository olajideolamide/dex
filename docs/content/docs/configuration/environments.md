...
Only enable DEX UI in production if you also configure a strict allowlist. See [Protecting the Dashboard](/docs/security/protecting-the-dashboard/).
{{< /callout >}}
...
- [Security Overview](/docs/security/overview/) — Production hardening checklist
- [Configuration Reference](/docs/configuration/config-reference/) — All options and env keys
